/**
 * $Id: CwmsRatingSingleIndep.java,v 1.1.1.1 2014/05/19 15:28:59 mmaloney Exp $
 * 
...
//AW:BEFORE_TIMESLICES
		...
		try
		{
			...
			ratingSet = crd.getRatingSet(specId);
                        ...
                        long rt = ratingSet.getRatingTime();
                        
                        long dates[] = ratingSet.getEffectiveDates();
                        Date d = new Date(rt);
                        debug3("Rating Time: " + d);
                        for( int i=0; i < dates.length; i++){
                            d = new Date(dates[i]);
                            debug3("Effective Date: " + d);
                        }
