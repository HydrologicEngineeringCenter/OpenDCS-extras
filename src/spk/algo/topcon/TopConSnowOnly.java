...
//AW:TIMESLICE
		...
		// Enter code to be executed at each time-slice.
                ...
                try{
                    ...
                    double tcs_rain = graph.get_allowed_storage(wy_day -1 , FloodControlParameter, false);
                    double tcs_snow = graph.get_allowed_storage(wy_day - 1, FloodControlParameter, true);// all of the graphs are zero based
