...
//AW:JAVADOC
/**
 * Remove the diurnal fluctuations in the Rain data caused by temperature
 * variations in the mineral oil used in our Catch Tubes ( some of the catch
 * tubes have been painted white which has eliminated the large +/- .2" swings
 * in precip; there will still be some minor +/-.02 swings due to temperature
 * variation of all involved components )
 *
 ...
 * able to use the version of setOutput with the date. We just have to keep
 * track of each time we find a gap greater than the current interval.
 *
 * @author L2EDDMAN
 */
//AW:JAVADOC_END
