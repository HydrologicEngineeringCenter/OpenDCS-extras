/**
 * $Id: SubSample.java,v 1.1.1.1 2014/05/19 15:28:59 mmaloney Exp $
 * 
 * $Log: SubSample.java,v $
 * REiving 2015/03/11 Mike Neilson remove section of code that was tweaking the end time by an hour for daylight savings changes
...
//AW:BEFORE_TIMESLICES
		...
		Date firstInputT = (Date)baseTimes.first();
